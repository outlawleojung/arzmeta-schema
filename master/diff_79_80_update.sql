...
insert into localization(id,kor,eng) values (N'juri_notice_walletaddress',N'이미 등록된 지갑 주소입니다.
지갑을 연결한 계정에서 지갑 연동 해제 후 사용 가능합니다.',N'This wallet address has already been registered.
You can use it after unlinking your wallet from a registered account.');
...
update spaceDetailType set type = 3101,name = N'유학박람회 로비' where type = 3101;
insert into spaceDetailType(type,name) values (3102,N'유학박람회 부스');
...
-- tablename : spaceInfo
insert into spaceInfo(spaceType,spaceDetailType) values (3,3102);
