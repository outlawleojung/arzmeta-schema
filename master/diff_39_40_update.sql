...
update interiorInstallInfo set itemId = 215007,prefab = N'-2146826246',layerType = 1,xSize = 1,ySize = 1,removable = 1 where itemId = 215007;
update interiorInstallInfo set itemId = 221016,prefab = N'-2146826246',layerType = 1,xSize = 1,ySize = 1,removable = 1 where itemId = 221016;

-- tablename : startInventory
insert into startInventory(itemId,count) values (215007,1);
insert into startInventory(itemId,count) values (221016,1);
