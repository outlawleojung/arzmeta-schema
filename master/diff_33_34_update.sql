...
insert into localization(id,kor,eng) values (N'office_grade_limit_info_advanced',N'고급 기능은 스탠다드 등급 이상부터 사용 가능합니다.',N'Advanced features are available above the standard.');
insert into localization(id,kor,eng) values (N'office_reservation_day',N'날짜',N'Date');
