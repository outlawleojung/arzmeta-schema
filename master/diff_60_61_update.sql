...
update localization set id = N'office_attendance',kor = N'입장 인원 ({0}/{1})',eng = N'Attendance ({0}/{1})' where id = 'office_attendance';
update localization set id = N'office_attendance_check',kor = N'입장 인원 ({0}/{1})',eng = N'Attendance ({0}/{1})' where id = 'office_attendance_check';
update localization set id = N'office_waitlist_check',kor = N'대기 인원 ({0})',eng = N'Waitlist ({0})' where id = 'office_waitlist_check';
