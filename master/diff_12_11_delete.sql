...
delete from localization where id = 'item_My_Wall_Pop_01';
delete from localization where id = 'item_My_Wall_Pop_01_description';
delete from localization where id = 'item_My_Lighrt_01';
delete from localization where id = 'item_My_Lighrt_01_description';
