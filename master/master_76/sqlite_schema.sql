...
;
create table if not exists adContents
(
    id                   int(11),
    moneyType            int(11),
    reward              varchar(64),
...
;
create table if not exists dynamicLinkType
(
    type                 int(11),
    name                varchar(64),
    primary key(type)
...
;
create table if not exists memberSelectVoteInfo
(
    memberId             varchar(100)    ,
    voteId               int(11),
    votenum              int(11),
    createdAt            datetime ,
    updatedAt            datetime ,
    primary key(memberId,voteId,votenum)
)
;
...
;
create table if not exists memberWalletInfo
(
    memberId             varchar(100)    ,
    walletAddr           varchar(2048) ,
    createdAt            datetime ,
    updatedAt            datetime ,
    primary key(memberId,walletAddr)
)
;
...
;
create table if not exists objectInteractionType
(
    type                 int(11),
    name                varchar(64),
    primary key(type)
...
;
create table if not exists officeSeatInfo
(
    spaceId              int(11),
    num                 int(11),
    seatName            varchar(64),
    primary key(spaceId,num)
)
;
...
;
create table if not exists screenContentType
(
    type                 int(11),
    name                varchar(64),
    primary key(type)
...
;
create table if not exists selectVoteInfo
(
    id                   int(11),
    name                varchar(64),
    voteCount           int(11),
    itemCount           int(11),
    resultType           int(11),
    resultExposureType   int(11),
    startedAt            datetime ,
    endedAt              datetime ,
    resultStartedAt      datetime ,
...
;
create table if not exists selectVoteItem
(
    voteId               int(11),
    votenum              int(11),
    name                varchar(64),
    ...
    createdAt            datetime ,
    updatedAt            datetime ,
    primary key(voteId,votenum)
)
;
create table if not exists selectVoteStateType
(
    type                 int(11),
    name                varchar(64),
    primary key(type)
...
;
create table if not exists spaceDetailType
(
    type                 int(11),
    name                varchar(64),
    primary key(type)
...
(
    spaceType            int(11),
    spaceDetailType      int(11),
    primary key(spaceType,spaceDetailType)
)
;
...
;
create table if not exists voteResultExposureType
(
    type                 int(11),
    name                varchar(64),
    primary key(type)
