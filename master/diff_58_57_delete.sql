...
delete from localization where id = 'office_reserved_creation';
...
delete from departmentType where type = 1;
delete from departmentType where type = 2;
...
delete from paymentProductManager where id = 1401;
delete from paymentProductManager where id = 1402;
delete from paymentProductManager where id = 1403;
...
delete from officeProductItem where productId = 1401;
delete from officeProductItem where productId = 1402;
delete from officeProductItem where productId = 1403;

-- tablename : officeGradeAuthority
delete from officeGradeAuthority where gradeType = 3;
delete from officeGradeAuthority where gradeType = 4;
