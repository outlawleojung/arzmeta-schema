...
insert into localization(id,kor,eng) values (N'office_state_order',N'현재 {0}명이 입장 대기 중입니다.\n나의 대기 순서: {1}번째',N'');
insert into localization(id,kor,eng) values (N'office_notice_start',N'{0} 일정이 시작되었습니다.',N'');
insert into localization(id,kor,eng) values (N'office_notice_room_info',N'룸 이름: {0} \n일시: {1} {2} \n관리자: {3}',N'');
