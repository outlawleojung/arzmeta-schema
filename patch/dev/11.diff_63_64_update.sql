...
insert into localization(id,kor,eng) values (N'game_roomcreat',N'방만들기',N'Creating a room');
insert into localization(id,kor,eng) values (N'system_common_withdrawal',N'고객님의 계정은 탈퇴 처리 중입니다.
탈퇴를 취소하시겠습니까?

<size=25><color=grey>탈퇴 요청일 30일 이후, 자동 탈퇴 처리됨
(탈퇴 요청일 : {0})</color></size>',N'Your account is being processed for Membership Withdrawal.
Do you want to cancel it?

<size=25><color=grey>After 30 days of withdrawal request, it will processed.
(Request Date : {0})</color></size>');
