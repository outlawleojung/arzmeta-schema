...
delete from localization where id = 'map_type_area';
delete from localization where id = 'map_type_brand';
delete from localization where id = 'map_officezone_name';
delete from localization where id = 'map_hancomcafe_name';
delete from localization where id = 'map_officezone_desc';
delete from localization where id = 'map_hancomcafe_desc';
